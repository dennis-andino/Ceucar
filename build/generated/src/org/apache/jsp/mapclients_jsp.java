...
import controlador.MapasController;

public final class mapclients_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    List<Mapa> milista = controlmap.obtenerCoordenadas();
      ...
      out.write("        <title>ceucar.com/mapeo</title>\n");
      out.write("        ");
      ...
      out.write("\n");
      out.write("        <script src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyAPqaY-K1Q0YEtqdO08W1Vv8KMrdSM8h2o\"></script>\n");
      out.write("        <script>\n");
      ...
      out.write("                map = new google.maps.Map(document.getElementById(\"mapCanvas\"), mapOptions);\n");
 ...
 for (int i = 0; i < milista.size(); i++) {
      ...
      out.write("                            '<h3>");
      out.print(milista.get(j).getNombre());
      out.write("</h3>' +\n");
      out.write("                            '<p>");
      out.print(milista.get(j).getEmailCli());
      out.write("</p>' + '</div>'],\n");
      out.write("            ");
 ...
 if (rol.equals("Ofertador")) {
      ...
      out.write("                <h5 class=\"card-title\">Mapeo de usuarios</h5>\n");
